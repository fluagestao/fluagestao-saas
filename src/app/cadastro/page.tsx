...
export default function CadastroPage() {
  ...
  const campos =
    "h-12 rounded-xl border-[#D9C6B2]/80 bg-white text-[#3F2422] shadow-[0_2px_8px_rgba(112,61,58,0.05)] placeholder:text-[#74745B]/50 focus-visible:border-[#A94F45] focus-visible:ring-[#A94F45]/15";
      ...
      <div className="relative mx-auto grid min-h-dvh w-full max-w-[1460px] items-center gap-10 px-5 py-8 sm:px-8 lg:grid-cols-[.92fr_1.08fr] lg:px-12 xl:gap-16 xl:px-16">
        <section className="hidden lg:flex lg:min-h-[620px] lg:flex-col lg:justify-center">
          <Link
            ...
            aria-label="Voltar ao site da Flua"
          >
            <Image
              src="/flua-logo.webp"
              alt="Flua Gestão"
